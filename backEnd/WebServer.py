...
_kRemoteAppName   = "svremoteviewer" # directory where we expect the remote app code
...
class WebServer(object):
    ...
    def __init__(self, msgQ, cmdQ, logDir, mainDir, port, auth, xmlRpcUrl,
        ...
        if hasattr(sys, "frozen"):
            ...
            self._remoteAppDir = os.path.join(os.getenv("SV_DEVEL_LIB_FOLDER_CONAN"), "..", "share", _kRemoteAppName)
