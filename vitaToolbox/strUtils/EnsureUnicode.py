...
def ensureUnicode(strOrUnicode, encoding="utf-8"):
    ...
    isn't unicode, which usually fails.
       Try: unicode('Vitamin D\xc2\xae Video')
    ...
    ...since that will fail if the string is already unicode:
       Try: unicode(u'Vitamin D\xae Video', 'utf-8')


    Note: doctest examples have an extra backslash in them to make doctest work.

    >>> ensureUnicode('Vitamin D\xc2\xae Video')
    u'Vitamin D\\xae Video'

    >>> ensureUnicode(ensureUnicode('Vitamin D\xc2\xae Video'))
    u'Vitamin D\\xae Video'

    >>> ensureUnicode('Vitamin D\xae Video', 'windows-1252')
    u'Vitamin D\\xae Video'

    >>> ensureUnicode(u'Vitamin D\xae Video', 'windows-1252')
    u'Vitamin D\\xae Video'
